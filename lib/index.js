...
class NotificationClient {
  ...
  async sendServiceRequestApproved(email, firstName, lastName, orgName, serviceName, requestedSubServices) {
    await send('userserviceadded_v2', {email, firstName, lastName, orgName, serviceName, requestedSubServices}, this.connectionString);
  }
