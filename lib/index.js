...
class NotificationClient {
  ...
  async sendServiceRequestToApprovers(approverEmail, approverName, senderName, senderEmail, orgName, requestedServiceName, requestedSubServices, rejectServiceUrl, approveServiceUrl) {
    await send('servicerequest_to_approvers_v1', { approverEmail, approverName, senderName, senderEmail, orgName, requestedServiceName, requestedSubServices, rejectServiceUrl, approveServiceUrl}, this.connectionString);
  }
