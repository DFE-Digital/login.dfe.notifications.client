...
class NotificationClient {
  ...
  async sendUserPermissionChanged(email,firstName, lastName, orgName, roleName){
    await send('changeuserpermissionlevelrequest_v1', {email,firstName,lastName,orgName, roleName}, this.connectionString);
  }
