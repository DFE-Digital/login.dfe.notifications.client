...
class NotificationClient {
  ...
  async sendEntraIdOTP(email, firstName, lastName, password, returnUrl) {
    await send('sendentraidotp', { email, firstName, lastName, password, returnUrl }, this.connectionString);
  }
