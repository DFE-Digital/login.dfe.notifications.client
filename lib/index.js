...
class NotificationClient {
  ...
  async sendServiceRequestApproved(email, firstName, lastName, orgName, serviceName, requestedSubServices, permissionName) {
    await send('userserviceadded_v2', {email, firstName, lastName, orgName, serviceName, requestedSubServices, permissionName}, this.connectionString);
  }
