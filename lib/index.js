...
class NotificationClient {
  ...
  async sendServiceRequestToApprovers(senderName, senderEmail, orgId, orgName, requestedServiceName, requestedSubServices, rejectServiceUrl, approveServiceUrl) {
    await send('servicerequest_to_approvers_v1', { senderName, senderEmail, orgId, orgName, requestedServiceName, requestedSubServices, rejectServiceUrl, approveServiceUrl}, this.connectionString);
  }
